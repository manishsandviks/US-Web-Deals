...
namespace deals.earlymoments.com.Models
{
    public class CommonModels
    {
        ...
        public string ResponsiveConfirmation_GiftingProducts(OrderVariables oVars, bool option = false, string template = "", bool isTableStripped = true)
        {
            string start_product_list = "<table id='tblCart' class='table table-striped bold'><tr><td>Item</td><td class='text-right'>Price</td></tr>";
            if (!isTableStripped)
                start_product_list = "<table id='tblCart' class='table'><tr><td>Item</td><td class='text-right'>Price</td></tr>";
